...
if not lang then
 return "🔒*english/Persian* _Posting Is Already Locked_🔒"
elseif lang then
 return "🔒ارسال کلمات انگلیسی در گروه هم اکنون ممنوع است🔒"
end
else
data[tostring(target)]["settings"]["lock_english"] = "yes"
save_data(_config.moderation.data, data)
if not lang then
 return "🔒*english/Persian* _Posting Has Been Locked_🔒"
else
...
if matches[1] == "permag" and is_mod(msg) then
	text10 = [[hi you can create bot at -> ]]
return text10
end
